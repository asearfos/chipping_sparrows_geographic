...
# three_feature_names = ['AvgSilenceDuration_ms', 'AvgSyllsLowerFreq_Hz', 'AvgSyllsUpperFreq_Hz']
# three_features = data.loc[:, three_feature_names].values
#
# # organizing data into sets
# train, test, train_labels, test_labels = train_test_split(three_features, labels, test_size=0.33, random_state=42)
...
# #
# # preds_bool = [bool(x) for x in preds]
# # print(np.where(preds_bool is False))
# # lat_test_east =long_test[np.where(preds_bool is False)[0]]
# # print(lat_test_east)
# # quit()
# #
...
# plt.tight_layout()
#
# pdf = PdfPages("C:/Users/abiga\Box Sync\Abigail_Nicole\ChippiesProject/StatsOfFinalData/MachineLearningClassifier/" +
