...
# combined_table_yr = combined_table.dropna(subset=['RecordingYear']).copy()
#
# # classify as before or after 1984
# combined_table_yr['1984'] = np.where(combined_table_yr['RecordingYear'] < 1984, 'before', 'after')
#
# # groupby before or after 1984 and syllable cluster; get total number of recordings before and after 1984
# clusters_over_time = combined_table_yr.groupby(['1984', 'ClusterNoAdjusted']).size(
