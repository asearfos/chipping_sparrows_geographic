...
with open(analysis_output) as csv_file:
    ...
    for row in csv_data:
        ...
        cursor.execute("INSERT INTO asearfos.Chippies_FinalData_AnalysisOutput_withReChipperedAndReExported"
...
cursor.execute("update asearfos.Chippies_FinalData_AnalysisOutput_withReChipperedAndReExported as chippies "
...
cursor.execute("update asearfos.Chippies_FinalData_AnalysisOutput_withReChipperedAndReExported "
               "set	CatalogNo = '9209' "
