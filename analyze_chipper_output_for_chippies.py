...
class SongAnalysis(object):
    ...
    def get_syllable_stats(self, syllable_durations, num_syllables, corr_thresh=40):
...
directory = "C:/Users/abiga\Box Sync\Abigail_Nicole/Urbanization\DebuggingAnalysis_1512L_SegSyllsOutput" \
            "\ProblemFile_OneSyllable"
